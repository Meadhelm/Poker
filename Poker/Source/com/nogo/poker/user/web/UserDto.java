...
public class UserDto implements IDomainObjectAware<User> {
  ...
  public User toDomainObject() {
    return new User.Builder().withName(name)
        .withEmail(email)
  ...
  public UserDto(final User user) {
    if (user != null) {
      ...
      this.createdDate = user.getCreatedDate() == null ? null : user.getCreatedDate()
          .toString();
      this.modifiedDate = user.getModifiedDate() == null ? null : user.getModifiedDate()
          .toString();
    }
  }
}
